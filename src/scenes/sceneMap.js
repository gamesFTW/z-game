...
SceneMap.prototype.createGraph = function() {
    var graph = require('ngraph.generators').balancedBinTree(8);
    this.graphManager = createPixiGraphics(graph, this.pixiStage);
...
SceneMap.prototype.render = function() {
    // Рендерим
    this.graphManager.renderOneFrame();
...
function createPixiGraphics(graph, settings, stage) {
  var NODE_WIDTH = 10;
